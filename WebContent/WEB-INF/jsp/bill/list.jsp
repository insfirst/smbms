...
<div class="right">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${pager.list }" varStatus="status">
				<tr>
					<td>
					...
					<td>
					<span><a class="viewBill" href="${pageContext.request.contextPath }/bill/view/${bill.id}"><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyBill" href="${pageContext.request.contextPath }/bill/modify/${bill.id}"><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
					<span><a class="deleteBill" href="${pageContext.request.contextPath }/bill/remove/${bill.id}"><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
					</td>
				</tr>
			</c:forEach>
      </table>
