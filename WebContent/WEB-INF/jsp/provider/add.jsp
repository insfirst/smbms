...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/add" enctype="multipart/form-data">
			<!-- <input type="hidden" name="method" value="add"> -->
                ...
                <div>
                    <label for="licPic">营业执照：</label>
                    <input type="file" name="licPic" id="licPic" value=""> 
                    <font color="red">${fillError}</font>
                </div>
