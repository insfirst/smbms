...
<div class="right">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${pager.list }" varStatus="status">
				<tr>
					<td>
					...
					<td>
					<span><a class="viewProvider" href="${pageContext.request.contextPath }/provider/view/${provider.id }" ><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyProvider" href="${pageContext.request.contextPath }/provider/modify/${provider.id }"><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
					<span><a class="deleteProvider" href="${pageContext.request.contextPath }/provider/remove/${provider.id }"><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
					</td>
				</tr>
			</c:forEach>
        </table>
